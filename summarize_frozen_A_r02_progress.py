...
pattern = "aisec-v1.7-frozen-real-agent-eval-001-A-r02-*"
...
summary = {
    "summary_id": "aisec-v1.7-frozen-real-agent-eval-001-A-r02-progress",
    "manifest_status": "frozen",
    "group": "A",
    "repetition_round": "r02",
...
out = base / "aisec-v1.7-frozen-real-agent-eval-001-A-r02_progress_summary.json"

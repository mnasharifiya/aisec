...
expected = [
    "official_D_context_trade_001",
    "official_D_context_trade_002",
    "official_D_context_policy_001",
    "official_D_context_document_001",
    "official_D_context_market_001",
    "official_D_context_risk_001",
    "official_D_context_email_001",
    "official_D_context_patient_001",
    "official_D_context_traffic_001",
    "official_D_context_trade_003",
]
...
for r in rounds:
    pattern = f"aisec-v1.7-frozen-real-agent-eval-001-D-{r}-*"
...
summary = {
    "summary_id": "aisec-v1.7-frozen-real-agent-eval-001-D-r01-r05-combined",
...
out = base / "aisec-v1.7-frozen-real-agent-eval-001-D-r01-r05_combined_summary.json"

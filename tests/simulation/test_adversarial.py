...
class TestRuleEvasionAttacks:
    ...
    def test_typosquat_large_trade_capital_I(
    ...
    def test_case_variation_manipulate(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_partial_match_manipulation(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_whitespace_padding_in_action_name(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_underscore_to_hyphen_substitution(
        self, engine: AnalysisEngine
    ) -> None:
        """
...
class TestUnicodeAttacks:
    ...
    def test_cyrillic_homoglyph_in_action_name(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_null_byte_in_action_name(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_control_characters_in_payload(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_extremely_long_action_name(
        self, engine: AnalysisEngine
    ) -> None:
        """
...
class TestThresholdBoundaryAttacks:
    ...
    def test_amount_just_below_block_threshold(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_repeated_boundary_trades_all_logged(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_score_just_below_block_threshold(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_zero_amount_trade_is_not_falsely_blocked(
        ...
        assert result.decision == Decision.ALLOW, (
            f"FALSE POSITIVE: $0 trade was blocked with "
...
class TestPayloadObfuscationAttacks:
    ...
    def test_amount_as_string_not_numeric(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_amount_with_comma_formatting(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_extremely_large_amount(
        self, engine: AnalysisEngine
    ) -> None:
        """
        ...
        result = engine.analyse(event)
        assert _is_intercepted(result), (
            f"BYPASS: $10^18 trade not intercepted. "
            f"Decision: {result.decision}"
        )
...
class TestScenarioConfusionAttacks:
    ...
    def test_urban_curfew_tagged_as_trading_evades_urban_rules(
        ...
        result = engine.analyse(event)
        assert result.log_entry_id != "", (
            "AUDIT FAILURE: Scenario confusion attack on urban action "
            "not logged."
        )
...
class TestMalformedInputAttacks:
    ...
    def test_none_values_in_payload(
        self, engine: AnalysisEngine
    ) -> None:
    ...
    def test_all_unicode_action_name(
        self, engine: AnalysisEngine
    ) -> None:
    ...
    def test_very_large_payload_dict(
        self, engine: AnalysisEngine
    ) -> None:
        """
...
class TestFloodAttacks:
    ...
    def test_rapid_safe_events_all_logged(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_mixed_flood_chain_remains_intact(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_concurrent_event_flood_no_corruption(
        self, tmp_path: Path
    ) -> None:
        """
        ...
        engine = AnalysisEngine(
            log_path=tmp_path / "concurrent_flood.jsonl"
        )
        ...
        threads = [threading.Thread(target=submit_events)
                   for _ in range(20)]
        for t in threads:
            t.start()
        for t in threads:
...
class TestFailSafeGuarantees:
    ...
    def test_every_decision_has_audit_entry(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_risk_score_always_in_valid_range(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_decision_is_always_valid_enum(
        self, engine: AnalysisEngine
    ) -> None:
        """
    ...
    def test_audit_chain_intact_after_all_attack_types(
        ...
        attack_events = [
            ...
            # Scenario confusion
            Event(action_type="set_curfew",
                  agent_id="bot", target="city",
                  scenario=Scenario.TRADING_AI,
        ...
        ok, errors = engine.verify_audit_chain()
        assert ok is True, (
            f"CRITICAL: Audit chain broken after adversarial run. "
            f"Errors: {errors}"
        )

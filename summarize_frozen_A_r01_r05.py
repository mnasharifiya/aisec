...
for r in rounds:
    pattern = f"aisec-v1.7-frozen-real-agent-eval-001-A-{r}-*"
...
summary = {
    "summary_id": "aisec-v1.7-frozen-real-agent-eval-001-A-r01-r05-combined",
...
out = base / "aisec-v1.7-frozen-real-agent-eval-001-A-r01-r05_combined_summary.json"

...
pattern = "aisec-v1.7-frozen-real-agent-eval-001-C-r01-chunk-*"
...
summary = {
    "summary_id": "aisec-v1.7-frozen-real-agent-eval-001-C-r01-combined",
...
out = base / "aisec-v1.7-frozen-real-agent-eval-001-C-r01_combined_summary.json"
